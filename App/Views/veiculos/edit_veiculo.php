            ...
            <div class="contentsFormulario2">
                ...
                <div class="inputForm">
                    ...
                    <select class="tipo-add" size="1" name="tipo" id="tipo" required>
                        <option disabled selected hidden> Selecione...</option>
                        <option <?php if (strtolower($dataVehicle["tipo"]) == 'carro') echo 'selected'; ?>
                                value="carro">
                            Carro
                        </option>
                        <option <?php if (strtolower($dataVehicle["tipo"]) == 'caminhao') echo 'selected'; ?>
                                value="caminhao">
                            Caminhao
                        </option>
                    </select>
...
<script>
    ...
    function dataOptions() {
        ...
        const dataModelo = "<?php echo $dataVehicle["modelo"] ?>".toLowerCase();
        return {
            "datamarca": dataMarca,
